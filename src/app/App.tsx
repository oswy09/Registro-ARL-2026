...
import { User, IdCard, HelpCircle, Check, Building2, FileText, Mail, Lock, Smartphone, Eye, EyeOff, X, ClipboardList, LogIn, ExternalLink, ArrowLeft, Info, AlertCircle, SearchX, UserCheck, ShieldCheck, RefreshCw, Clock, Home, Bell, Key, MousePointerClick, Zap, Phone, BookOpen, FastForward } from 'lucide-react';
